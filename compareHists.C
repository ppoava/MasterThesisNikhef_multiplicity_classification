...
int compareHists()
{
    ...
    doComparisonTH1("BplusBminus_minbias_bb_1e5.root", "minbias-bb", "BplusBminus_hardbbbar_1e5.root", "hardbbbar", vHistNamesTH1);
    doComparisonTH2("BplusBminus_minbias_bb_1e5.root", "minbias-bb", "BplusBminus_hardbbbar_1e5.root", "hardbbbar", vHistNamesTH2);
    ...
    doComparisonTH1("DplusDminus_minbias_cc_1e5.root", "minbias-cc", "DplusDminus_hardccbar_1e5.root", "hardccbar", vHistNamesTH1);
    doComparisonTH2("DplusDminus_minbias_cc_1e5.root", "minbias-cc", "DplusDminus_hardccbar_1e5.root", "hardccbar", vHistNamesTH2);
